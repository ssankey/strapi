...
export interface ApiLocationDataLocationData extends Schema.CollectionType {
  collectionName: 'location_datas';
  info: {
    singularName: 'location-data';
    pluralName: 'location-datas';
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<
      'api::location-data.location-data',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiSellingPackageSellingPackage extends Schema.CollectionType {
  collectionName: 'selling_packages';
  info: {
    singularName: 'selling-package';
    pluralName: 'selling-packages';
    displayName: 'sellingPackage';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::location-data.location-data': ApiLocationDataLocationData;
